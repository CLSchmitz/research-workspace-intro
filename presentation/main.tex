...
\begin{frame}{Getting Started}
  ...
  \vspace{1em}
  \textbf{Template repo:} Alternatively, just use my template and follow the instructions to set my exact workspace up: github.com/YOUR-USERNAME/research-workspace-template
\end{frame}
